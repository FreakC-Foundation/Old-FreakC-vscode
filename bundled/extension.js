...
function activate(context) {
    var sel = { scheme: 'file', language: 'freakc' };
    var provider1 = vscode.languages.registerCompletionItemProvider(sel, {
    ...
    var provider2 = vscode.languages.registerCompletionItemProvider(sel, {
